...
vvas_xyolovx::vvas_xyolovx (vvas_xkpriv * kpriv, const std::string & model_name,
...
int
vvas_xyolovx::run (vvas_xkpriv * kpriv, std::vector<cv::Mat>& images,
...
int
vvas_xyolovx::requiredwidth (void)
{
...
int
vvas_xyolovx::requiredheight (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_xyolovx::supportedbatchsz (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_xyolovx::close (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
  return true;
}

vvas_xyolovx::~vvas_xyolovx ()
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
}
